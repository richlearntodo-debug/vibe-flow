...
if errorlevel 1 exit /b 1
"C:\Windows\Microsoft.NET\Framework64\v4.0.30319\csc.exe" /nologo /target:winexe /platform:anycpu /out:"%~dp0VibeMicAtvvCapture.exe" /reference:System.Runtime.WindowsRuntime.dll /reference:System.Runtime.InteropServices.WindowsRuntime.dll /reference:"%~dp0tools\system.runtime.4.3.1\ref\net462\System.Runtime.dll" /reference:"%~dp0tools\microsoft.windows.sdk.contracts\ref\netstandard2.0\Windows.WinMD" /reference:"%~dp0tools\microsoft.windows.sdk.contracts\ref\netstandard2.0\Windows.Foundation.FoundationContract.winmd" /reference:"%~dp0tools\microsoft.windows.sdk.contracts\ref\netstandard2.0\Windows.Foundation.UniversalApiContract.winmd" "%~dp0scripts\VibeMicAtvvCapture.cs"
if errorlevel 1 exit /b 1
